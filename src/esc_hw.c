...
void ESC_ALeventmaskwrite (uint32_t mask)
{
    ...
    ESC_write (ESCREG_ALEVENTMASK, &mask, sizeof(mask));
}
...
void ESC_interrupt_enable (void)
{
...
void ESC_init (void)
{
   ...
   uint32_t timeout = 1000; // wait 100msec
         ...
         bool cs1 = false; // select CS1 pin
         bool rpi4 = true; // select clock divider for raspberry pi 4 or newer
     bool cs0 = true;
      ...
      if (bcm2835_spi_begin())
      {
         ...
         if (rpi4)
         {
            ...
            bcm2835_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_32);
             UM_INFO(GBLAN9252_UM_EN, "GBLAN9252: bcm2835_spi_setClockDivider set to 32");
         }
         else
         {
            // Set SPI clock speed BCM2835_SPI_CLOCK_DIVIDER_16 = 16, 16 = 64ns = 15.625MHz
            bcm2835_spi_setClockDivider(BCM2835_SPI_CLOCK_DIVIDER_16);
             UM_INFO(GBLAN9252_UM_EN, "GBLAN9252: bcm2835_spi_setClockDivider set to 16");
         }
         if (cs1)
         {
            ...
            bcm2835_spi_setChipSelectPolarity(BCM2835_SPI_CS1, LOW);
             UM_INFO(GBLAN9252_UM_EN, "GBLAN9252: bcm2835_spi_chipSelect set to CS1");
         }
         else
         {
            ...
            bcm2835_spi_setChipSelectPolarity(BCM2835_SPI_CS0, LOW);
             UM_INFO(GBLAN9252_UM_EN, "GBLAN9252: bcm2835_spi_chipSelect set to CS0");
         ...
         do
         {
            ...
            printf("value: [0x%x] test [0x%x]\n", value, ESC_RESET_CTRL_RST);
         ...
         if (counter < timeout)
         {
            ...
            value = bcm2835_spi_read_32(ESC_CMD_ID_REV);
             UM_INFO(GBLAN9252_UM_EN, "GBLAN9252_SOES: Detected chip [0x%x] Rev [%u]", ((value >> 16) & 0xFFFF), (value & 0xFFFF));

//             value=0x00000004;
             // Set AL event mask
             value = (ESCREG_ALEVENT_DC_SYNC0);
...
//            {
             ...
             UM_INFO(GBLAN9252_UM_EN, "GBLAN9252: Enabling rising edge interrupt on SYNC0 pin");
             bcm2835_gpio_fsel(SYNC0_PIN, BCM2835_GPIO_FSEL_INPT);
             bcm2835_gpio_ren(SYNC0_PIN);

             LL_DEBUG(GBLAN9252_GEN_LOG_EN, "GBLAN9252: Hardware interrupts are enabled");
...
//            }
         ...
         {
             UM_ERROR(GBLAN9252_UM_EN, "GBLAN9252: Timeout during chip reset");
            bcm2835_spi_end();
            bcm2835_close();
         }
      }
      ...
      {
          UM_ERROR(GBLAN9252_UM_EN, "GBLAN9252: bcm2835_spi_begin failed. Are you running as root?");
         bcm2835_close();
      }
   }
   else
   {
       UM_ERROR(GBLAN9252_UM_EN, "GBLAN9252: bcm2835_init failed. Are you running as root?");
   }
}
